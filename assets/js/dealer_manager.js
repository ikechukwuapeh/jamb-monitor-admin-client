$("#assign_pin").click(function(e){
	...
	if ((number != "" && amount != "") && (id != "")) {
		$.post('../inc/processor.php',{assign_dealer_pin:1,dealer_id:id,number:number,amount:amount},function(data){
            if (data == 'Yes') {
                location.href = "";
             }else{
...
$("#update_payment").click(function(e){
	...
	id = $("#id").val();
	if (amount_sub != "" && id != "") {
		$.post('../inc/processor.php',{update_dealer_payment:1,dealer_id:id,amount_sub:amount_sub},function(data){
            if (data == 'Yes') {
                location.href = "";
             }else{
